...
The outside is the only real 3D on the site. The igloo's blocks are translucent ice (a physical material with transmission), pale cyan at the base and white toward the top, over a light-cyan joint sphere; blob shadows, no shadow maps. At night a warm light inside makes the whole dome glow through the blocks and spill out of the door; the sky gets stars and slow aurora curtains and the snow catches green and violet. Evening turns the field peach and lilac with a low warm sun. It follows the same three modes as the room.
